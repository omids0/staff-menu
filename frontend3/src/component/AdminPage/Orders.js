                      ...
                      allOrders?.map((item) => (
                        ...
                        >
                          ...
                          <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            {item.serviceType === "service" && <p>پیک</p>}
                            {item.serviceType === "out" && <p>بیرون بر</p>}
                            {item.serviceType === "inner" && <p>داخل سالن</p>}
                          </td>
                          <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            {item.tableNum}
                          </td>
                          <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            ...
                            <p>{item.customer[0].customerTel}</p>
